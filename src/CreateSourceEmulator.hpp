...
createSourceEmulator(const appfwk::app::ConnectionReference qi, std::atomic<bool>& run_marker)
{
  ...
  static constexpr int tde_time_tick_diff = dunedaq::detdataformats::tde::ticks_between_adc_samples;
  static constexpr double tde_dropout_rate = 0.0;
  static constexpr double tde_rate_khz = 62500./(dunedaq::detdataformats::tde::ticks_between_adc_samples*dunedaq::detdataformats::tde::tot_adc16_samples);
  static constexpr int tde_frames_per_tick = dunedaq::detdataformats::tde::n_channels_per_frame;
